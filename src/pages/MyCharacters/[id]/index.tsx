...
import {
  ...
  getEquipmentBySlot,
  unequipItem,
} from "@/entities/character/lib/allEquipment";
...
export const MyCharacterPage: FC = () => {
  ...
  const [isEquipmentModalOpen, setIsEquipmentModalOpen] = useState<
    Character.EquipmentSlot | undefined
  >(undefined);
  ...
  useEffect(() => {
    ...
    const setCharacter = () => {
      ...
      EventBus.emit("CharacterViewScene:setCharacter", current);
      if (!current) return;
    };
              ...
              <div className="grid grid-cols-2 gap-2 w-full px-2 pt-4 pb-2 border-b-2 border-amber-900">
                ...
                <span className="text-3xl text-white text-right flex justify-end">
                  {isHover &&
                    totalStats &&
                    totalNewStats &&
                    totalStats.power !== totalNewStats.power && (
            ...
            >
              <div className="grid grid-cols-2 gap-2 w-full px-2 pt-4 pb-2 border-b-2 border-amber-900">
                ...
                <span className="text-3xl text-white text-right flex justify-end">
                  ...
                  {Math.floor(
                    (totalStats.advancedStats?.critChance || 0.5) * 100,
                  )}
                  %
                </span>
              </div>
              <div className="grid grid-cols-2 gap-2 w-full px-2 pt-4 pb-2 border-b-2 border-amber-900">
                ...
                <span className="text-3xl text-white text-right flex justify-end">
                  ...
                  {Math.floor(
                    (totalStats.advancedStats?.critDamage || 1.5) * 100,
                  )}
                  %
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 w-full px-2 pt-4 pb-2 border-b-2 border-amber-900">
                ...
                <span className="text-3xl text-white text-right flex justify-end">
                  ...
                  {Math.floor(
                    (totalStats.advancedStats?.accuracy || 0.01) * 100,
                  )}
                  %
                </span>
              </div>
          ...
          <div className="absolute left-[33.33%] right-0 bottom-0 h-1/3 bg-gray-900/30 flex flex-col items-center justify-center p-8 gap-2">
            ...
            <div className="grid grid-cols-5 gap-4 mb-4">
              <EquipmentCard
                ...
                onClick={() =>
                  setIsEquipmentModalOpen(Character.EquipmentSlot.WEAPON)
                }
              />
              <EquipmentCard
                fallback="orange_helmet"
                equipment={equipment.helmet}
                onClick={() =>
                  setIsEquipmentModalOpen(Character.EquipmentSlot.HELMET)
                }
              />
              <EquipmentCard
                fallback="orange_chest"
                equipment={equipment.chest}
                onClick={() =>
                  setIsEquipmentModalOpen(Character.EquipmentSlot.CHEST)
                }
              />
              <EquipmentCard
                fallback="orange_boots"
                equipment={equipment.boots}
                onClick={() =>
                  setIsEquipmentModalOpen(Character.EquipmentSlot.BOOTS)
                }
              />
              <EquipmentCard
                fallback="emerald_necklace_accessory"
                equipment={equipment.accessory}
                onClick={() =>
                  setIsEquipmentModalOpen(Character.EquipmentSlot.ACCESSORY)
                }
              />
            </div>
            {isMaxLevel ? (
