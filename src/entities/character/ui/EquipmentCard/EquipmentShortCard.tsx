...
export const EquipmentShortCard = ({
  equipment,
  onClick,
  size = 120,
  iconSize = 80,
  ...
  return (
    <div
      className={`backdrop-blur-sm rounded-xl p-2 border border-black/50 cursor-pointer relative w-fit ${className}`}
      onClick={onClick}
    >
      <EquipmentCard
        withLevel
      ...
      {withEquipedCharacter && (
        <img
          ...
          className="absolute bottom-0 right-0 size-[40px] z-10"
          style={{
